...
//        AdSettings.setTestMode(true);
    ...
    public static String AppLovingIDInterADS(){
         String[] AppLoving = getAppLovinInter().split(",");
        if (AppLoving.length == 1) {
             return AppLoving[0];
        }
        return AppLoving[getRandomNumber(0, AppLoving.length - 1)];
    }
