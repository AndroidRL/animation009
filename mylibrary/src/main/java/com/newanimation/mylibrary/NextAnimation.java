...
import static com.newanimation.mylibrary.MyProHelperClass.AppLovingIDInterADS;
...
//                    AllAdsPreLoadsInter("f");
    ...
    public static void AppLovingInterPreLoad() {
        ...
        applovin_interstitialAd = new MaxInterstitialAd(AppLovingIDInterADS(), (Activity) main_context);
...
//                AllAdsPreLoadsInter("a");
    ...
    private static void onDemandAppLoving() {
        ...
        applovin_interstitialAd.setListener(new MaxAdListener() {
            ...
            @Override
            public void onAdDisplayFailed(MaxAd ad, MaxError error) {
                Toast.makeText(main_context, "onSdDisplayFailed"  , Toast.LENGTH_SHORT).show();
            }
        });
        applovin_interstitialAd.loadAd();
    }
